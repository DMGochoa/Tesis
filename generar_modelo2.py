...
def main(Ktrain=0.0005, Ktest=0.005, iteraciones=150, base=pd.DataFrame()):
    ...
    print('[', str(Ktrain * 100), '%] t=', "%.2f" % (time.time() - instante0),
          'seg para crear las muestras de entrenamiento y',
...
if __name__ == '__main__':
    ...
    for i in range(datos[4].__len__()):
        pickle.dump(modelos[i],
                    open('Modelos/modelo2/modelo' + str(i) + '_para_' + str(porcen) + '_porciento.pkl', 'wb'))
    ...
    promedios.to_csv('Modelos/modelo2/promedios_para_' + str(porcen) + '_porciento.csv')
    validaciones.to_csv('Modelos/modelo2/scores_para_' + str(porcen) + '_porciento.csv')
    entrenamiento0.to_csv('Modelos/modelo2/datos0_para_' + str(porcen) + '_porciento.csv')
    entrenamiento1.to_csv('Modelos/modelo2/datos1_para_' + str(porcen) + '_porciento.csv')
    tiempos.to_csv('Modelos/modelo2/tiempos_para_' + str(porcen) + '_porciento.csv')
